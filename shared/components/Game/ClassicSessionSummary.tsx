  ...
  return (
    <div className='fixed inset-0 z-50 flex h-full w-full flex-col overflow-x-hidden overflow-y-auto bg-(--background-color)'>
      <div className='mx-auto flex min-h-full w-full max-w-[1240px] flex-1 flex-col justify-start px-4 py-8 sm:min-h-[100dvh] sm:justify-center sm:px-8 sm:py-20 lg:px-12 lg:py-16'>
        ...
        {/* Action Buttons */}
        <div className='mt-auto flex w-full items-center justify-center gap-3 pt-4 select-none sm:justify-start sm:gap-5 sm:pt-0'>
          <button
            onClick={onBackToSelection}
            className='flex h-14 flex-1 cursor-pointer items-center justify-center gap-3 rounded-[2rem] bg-(--secondary-color) px-6 text-lg font-bold text-(--background-color) lowercase outline-hidden transition-all duration-150 active:scale-95 active:brightness-95 sm:flex-none sm:px-10 sm:text-xl'
          >
          ...
          <button
            ...
            className='flex h-14 flex-2 cursor-pointer items-center justify-center gap-3 rounded-[2rem] bg-(--main-color) px-6 text-lg font-bold text-(--background-color) lowercase outline-hidden transition-all duration-150 active:scale-95 active:brightness-95 sm:flex-none sm:px-12 sm:text-xl'
          >
