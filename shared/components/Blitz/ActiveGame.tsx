  ...
  return (
    <form onSubmit={onSubmit} className='space-y-4'>
      <input
        ...
        className='w-full rounded-lg border-2 border-(--border-color) bg-(--card-color) p-4 text-center text-lg text-(--secondary-color) outline-none focus:border-(--secondary-color) focus-visible:outline-none'
